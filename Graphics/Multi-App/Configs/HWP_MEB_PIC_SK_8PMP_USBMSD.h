...
*********************************************************************/
/*
    Due to the fact that the Graphics Multi-App Demo uses USB Host and
    Device at the same time, the flash programming will only be set up 
    to use the UART port.
    
    USE_COMM_PKT_MEDIA_SERIAL_PORT - to use UART port as the flash programming port
    
    For hardware with no UART, the use of external flash memory for
    storage of images and/or fonts is disabled.
...
/* SD Card definitions: Change these to fit your application when using
   an SD-card-based physical layer                                   */
		...
		/*
		// Description: SD-SPI Chip Select Output bit
		#define SD_CS               LATBbits.RB9
		// Description: SD-SPI Chip Select TRIS bit
		#define SD_CS_TRIS          TRISBbits.TRISB9
	    
		// Description: SD-SPI Card Detect Input bit
		#define SD_CD               LATGbits.RG0
		// Description: SD-SPI Card Detect TRIS bit
		#define SD_CD_TRIS          TRISGbits.TRISG0

		// Description: SD-SPI Write Protect Check Input bit
		#define SD_WE               LATGbits.RG1
		// Description: SD-SPI Write Protect Check TRIS bit
		...
		*/
		...
		// Description: SD-SPI Chip Select Output bit
		#define SD_CS   LATGbits.RG6
		// Description: SD-SPI Chip Select TRIS bit
		#define SD_CS_TRIS  TRISGbits.TRISG6
		// Description: SD-SPI Card Detect Input bit
		#define SD_CD   LATAbits.RA15
		// Description: SD-SPI Card Detect TRIS bit
		#define SD_CD_TRIS  TRISAbits.TRISA15
		// Description: SD-SPI Write Protect Check Input bit
		#define SD_WE   LATAbits.RA7
		// Description: SD-SPI Write Protect Check TRIS bit
