...
//                                  MAIN
/////////////////////////////////////////////////////////////////////////////
GOL_SCHEME   *AN1136Scheme;                // alternative style scheme
...
/////////////////////////////////////////////////////////////////////////////
// Function: WORD CreateAN1136(void)
// Input: None
...
/////////////////////////////////////////////////////////////////////////////
WORD CreateAN1136(void)
{
    AN1136Scheme = GOLCreateScheme();  // create alternative style scheme
    AN1136Scheme->TextColor0 = BLACK;
    AN1136Scheme->TextColor1 = BRIGHTBLUE;
    ...
    (
        ...
        AN1136Scheme                // use alternative style scheme
    ))
        return 0;                              
...
/////////////////////////////////////////////////////////////////////////////
// Function: WORD MsgAN1136Callback(WORD objMsg, OBJ_HEADER* pObj, GOL_MSG* pMsg)
...
/////////////////////////////////////////////////////////////////////////////
WORD MsgAN1136Callback(WORD objMsg, OBJ_HEADER *pObj, GOL_MSG *pMsg)
{
    WORD    objectID;
    SLIDER  *pSldObj;
