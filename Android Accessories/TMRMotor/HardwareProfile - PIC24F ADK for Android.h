...
#define HARDWARE_PROFILE_PIC24F_ADK_FOR_ANDROID_H  
    ...
    /** PWM ***************************************************************/
    #define InitIN()  {TRISF = 1; LATF = 1;}

    /** PWM Out ************************************************************/
    #define mInitPWM_RD10()  {RPOR1bits.RP3R = 0; LATDbits.LATD10 = 0; TRISDbits.TRISD10 = 0;}


    /** MOTOR ************************************************************/
    #define InitMOTOR()  {TRISD = 0; LATD = 0;}
	
    #define mMOTOR              PORTDbits.RD10

    #define MOTOR_On()		 mMOTOR = 1;

    #define MOTOR_Off()		 mMOTOR = 0;
    ...
    //#define SetLEDs(BYTE setting);
    //#define GetPushbuttons(void);
    //define ReadPOT(void);
    ...
    /** All LEDs On/Off */
    #define LEDAll_On()         {LED0_On(); LED1_On(); LED2_On(); LED3_On(); LED4_On(); LED5_On(); LED6_On(); LED7_On(); }
    #define LEDAll_Off()         {LED0_Off(); LED1_Off(); LED2_Off(); LED3_Off(); LED4_Off(); LED5_Off(); LED6_Off(); LED7_Off(); }
