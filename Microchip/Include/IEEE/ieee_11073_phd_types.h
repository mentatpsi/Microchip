/************************************************************************
  File Information:
    FileName:       ieee_11073_phd_types.h
    Dependencies:   None

  Description:
    This File contains the Encoded data type definitions used in IEEE Std 11073-20601 standard. 
    These follow recommendation from Annex H (Encoded data type definitions) of IEEE Std 11073-20601-2008     
    
    This file is located in the "\<Install Directory\>\\Microchip\\Include\\IEEE"
    directory.
...
********************************************************************/
#ifndef _IEEE_11073_PHD_TYPES 
    #define _IEEE_11073_PHD_TYPES 
