/******************************************************************************
  ...
  USB POS Printer Definition File - Epson TM-T88IV

  Summary:
    This is a definition file for the Epson TM-T88IV Point-of-sale USB
    Printer.
...
* FileName:        usb_printer_pos_epson_tm_t88iv.c
* Dependencies:    None
