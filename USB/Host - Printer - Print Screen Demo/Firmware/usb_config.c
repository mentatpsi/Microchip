...
// Created by the Microchip USBConfig Utility, Version 1.0.4.0, 4/23/2008, 13:18:30
...
{
    { 0x04B8, 0x0202, 2, {LANGUAGE_SUPPORT_FLAGS_ESCPOS} }   // Epson TM-T88IV, ESC/POS
    ,
    { 0x03F0, 0x1312, 0, {LANGUAGE_SUPPORT_FLAGS_PCL3} }    // HP Deskjet 460
    ,
    { 0x043D, 0x00F2, 1, {LANGUAGE_SUPPORT_FLAGS_POSTSCRIPT} }    // Lexmark Laser
    ,
    { 0x0000, 0x0000, 0, {0} }
};
...
USB_TPL usbTPL[] =
{
    ...
    ,
    { INIT_VID_PID( 0x03F0ul, 0x1312ul ), 0, 0, {0} } // HP Deskjet 460
    ,
    { INIT_VID_PID( 0x043Dul, 0x00F2ul ), 0, 0, {0} } // Lexmark E250dn
};
