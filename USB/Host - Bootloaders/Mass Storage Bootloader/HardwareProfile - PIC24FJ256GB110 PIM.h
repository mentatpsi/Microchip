...
#define HARDWARE_PROFILE_PIC24FJ256GB110_PIM_H
    ...
    #define mDeInitAllLEDs()    LATA = 0xFFFF; TRISA = 0x36FF;
    ...
    /** SWITCH *********************************************************/
    #define mInitSwitch0()      TRISDbits.TRISD13=1;
    #define mInitSwitch2()      TRISDbits.TRISD6=1;
    #define mInitSwitch3()      TRISDbits.TRISD7=1;
    #define mInitAllSwitches()  mInitSwitch2();mInitSwitch3();mInitSwitch0();
    #define sw0                 PORTDbits.RD13
