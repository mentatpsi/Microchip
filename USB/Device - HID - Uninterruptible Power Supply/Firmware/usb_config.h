...
//Modes that offer ping pong buffering on EP0 OUT (ex: USB_PING_PONG__EP0_OUT_ONLY 
//and USB_PING_PONG__FULL_PING_PONG) provide superior control transfer handling 
//timing performance, and are therefore recommended over the other modes.
