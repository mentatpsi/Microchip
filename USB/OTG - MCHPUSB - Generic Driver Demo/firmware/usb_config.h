...
//Cable Selection
#define USB_MICRO_AB_OTG_CABLE  //Comment this out if not using a Micro AB OTG Cable

//Default Role Selections
//#define DEFAULT_ROLE    ROLE_DEVICE
...
//#define	USB_OTG_APP_EVENT_HANDLER USB_OTGApplicationEventHandler
