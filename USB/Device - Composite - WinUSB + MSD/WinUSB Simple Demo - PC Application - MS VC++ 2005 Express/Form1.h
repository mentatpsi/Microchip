...
/********************************************************************
 ...
 Dependencies:	Windows Server 2003 Platform SDK during development.  
				Also need WDK 7600.16385.0 (see includes section for 
...
#define MY_DEVICE_ID  "Vid_04d8&Pid_005F"	
...
//-------------------------------------------------------BEGIN CUT AND PASTE BLOCK-----------------------------------------------------------------------------------
		 ...
		 //I/O operations.
		 WinUsb_WritePipe(MyWinUSBInterfaceHandle, 0x02, &OutputPacketBuffer[0], 64, &BytesWritten, NULL);  
//-------------------------------------------------------END CUT AND PASTE BLOCK-------------------------------------------------------------------------------------
//-------------------------------------------------------------------------------------------------------------------------------------------------------------------
		 }
...
//-------------------------------------------------------BEGIN CUT AND PASTE BLOCK-----------------------------------------------------------------------------------
		 ...
		 WinUsb_ReadPipe(MyWinUSBInterfaceHandle, 0x82, &InputPacketBuffer[0], 64, &BytesRead, NULL);  
