...
#define HARDWARE_PROFILE_PIC18F47J53_PIM_H
    ...
    #define mInitSwitch3()      TRISBbits.TRISB0 =1; //mInitSwitch2();
    ...
    #define mInitPOT()          {TRISAbits.TRISA0=1;			\
    							 ANCON0bits.PCFG0 = 1;			\
    							 ADCON0=0x01;					\
    							 ADCON1=0x9E;}		// POT on PIC18 Explorer
    /** I/O pin definitions ********************************************/
    #define INPUT_PIN 1
    #define OUTPUT_PIN 0
    ...
    #define LCD_RST LATBbits.LATB5
    #define LCD_RST_TRIS TRISBbits.TRISB5 
    
    /*** SPI Configuration ********************************************/
    #define SPI_CLK_TRIS TRISBbits.TRISB1
    #define SPI_SDO_TRIS TRISAbits.TRISA5
