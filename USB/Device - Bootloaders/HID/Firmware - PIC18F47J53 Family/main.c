...
PIC18F47J53 FS USB Demo Board.  It can be readily adapted to
work with other members of the PIC18F47J53 Family of USB microcontrollers 
as well ('F' and 'LF' versions of PIC18F26J53/27J53/46J53/47J53).
...
void LowVoltageCheck(void)
{
    #warning "Recommended to implement similar functionality for your device using ADC, HVLD, comparators, or other means."
}    
#endif
