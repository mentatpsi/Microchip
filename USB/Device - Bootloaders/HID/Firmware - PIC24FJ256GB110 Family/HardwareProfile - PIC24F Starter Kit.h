...
#define HARDWARE_PROFILE_PIC24F_STARTER_KIT_H
    ...
    #define mSetLED_1(in)       if(in == 1){mLED_1_On();}else{mLED_1_Off();}
    #define mSetLED_2(in)       if(in == 1){mLED_2_On();}else{mLED_2_Off();}
    #define mSetLED_3(in)       if(in == 1){mLED_3_On();}else{mLED_3_Off();}
    #define mSetLED_4(in)       
