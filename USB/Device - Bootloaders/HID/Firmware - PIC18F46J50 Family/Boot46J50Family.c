/*********************************************************************
 *
 *   HID Device Bootloader Firmware for PIC18F46J50 Family Devices
 *
 *********************************************************************
 * FileName:        Boot46J50Family.c
...
#define CONFIG_WORDS_SECTION_LENGTH		8   	//8 bytes worth of Configuration words on the PIC18F46J50 family devices
...
#define ERASE_PAGE_ADDRESS_MASK         0xFFFC00
	...
	#define CONFIG_WORDS_START_ADDRESS	0x003FF8 //0xXXXF8 is CONFIG1L on PIC18F46J50 family devices
#elif defined(__18F25J50)||defined(__18F45J50)||defined(__18LF25J50)||defined(__18LF45J50)
	...
	#define CONFIG_WORDS_START_ADDRESS	0x007FF8 //0xXXXF8 is CONFIG1L on PIC18F46J50 family devices
#elif defined(__18F26J50)||defined(__18F46J50)||defined(__18LF26J50)||defined(__18LF46J50)
	...
	#define CONFIG_WORDS_START_ADDRESS	0x00FFF8 //0xXXXF8 is CONFIG1L on PIC18F46J50 family devices
#endif
