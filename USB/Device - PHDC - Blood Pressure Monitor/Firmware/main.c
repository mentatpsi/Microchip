...
void LCDScreenUpdate (void)
{
    ...
    if (lcdCount <= 0)
    {
        ...
        {    
            ...
            TempValue = BloodPressure.systolic.Val;
            ...
            TempValue = BloodPressure.diastolic.Val;
            Temp = InitgerToAscii(TempValue);
            LCDText[4] = Temp[0];
            LCDText[5] = Temp[1];
            LCDText[6] = 'm';
            ...
            LCDText[12] = 'R';
            LCDText[13] = '-';
            TempValue = BloodPressure.pulseRate.Val; 
            Temp = InitgerToAscii(TempValue); 
            LCDText[14] = Temp[0]; 
            LCDText[15] = Temp[1]; 
            ...
            ////////////////////////////////////////////// 
                ...
                //LCDText[9] = (TempValue & 0x0F) + 0x30; // LSB of mon
        
                //TempValue = TempValue>>4;
                //LCDText[8] = (TempValue & 0x0F) + 0x30; // MSB of mon
