...
/**
 * 
 * DemoLibUSB class is a demo class that interfaces to the LibUSB demos
 ...
 */
public class DemoLibUSB extends Demo implements Runnable, DemoInterface {
	...
	private final static int LIBUSB_DEMO_BUTTON_PRESSED = (int)0x00;
	 ...
	 */
	DemoLibUSB(Context context, UsbDevice device, Handler handler) {
	...
	public String getDeviceTitle() {
		if(device != null) {
			return "LibUSB Device Demo (VID = 0x" + Integer.toHexString(device.getVendorId()) + 
	...
	public void run() {	
		...
		while(true) {
			...
			if(result > 0) {
				...
				boolean currentButtonState = (getPushButtonStatusResults[1]==LIBUSB_DEMO_BUTTON_PRESSED)?true:false;
