...
/** VARIABLES ******************************************************/
    ...
    //a USB module accessible portion of microcontroller RAM.
        ...
        #define RX_BUFFER_ADDRESS 0x260
        #define TX_BUFFER_ADDRESS (RX_BUFFER_ADDRESS + 64)
        #define MIDI_EVENT_ADDRESS  (TX_BUFFER_ADDRESS + 64)

        #define RX_BUFFER_ADDRESS_TAG @RX_BUFFER_ADDRESS
        #define TX_BUFFER_ADDRESS_TAG @TX_BUFFER_ADDRESS
        #define MIDI_EVENT_ADDRESS_TAG @MIDI_EVENT_ADDRESS
        ...
        #define RX_BUFFER_ADDRESS 0x500
        #define TX_BUFFER_ADDRESS (RX_BUFFER_ADDRESS + 64)
        #define MIDI_EVENT_ADDRESS  (TX_BUFFER_ADDRESS + 64)
        ...
        #define RX_BUFFER_ADDRESS 0x480
        #define TX_BUFFER_ADDRESS (RX_BUFFER_ADDRESS + 64)
        #define MIDI_EVENT_ADDRESS  (TX_BUFFER_ADDRESS + 64)
        ...
        #define RX_BUFFER_ADDRESS 0x2050
        #define TX_BUFFER_ADDRESS 0x2190
        #define MIDI_EVENT_ADDRESS  (TX_BUFFER_ADDRESS + 64)
