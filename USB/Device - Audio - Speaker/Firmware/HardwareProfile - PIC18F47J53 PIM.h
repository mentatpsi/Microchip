...
#define HARDWARE_PROFILE_PIC18F47J53_PIM_H
    ...
    /*** Intialize Audio Driver on the Speech Playback Card *********************************************/ 
 	#define mInitAudioDriver()  {TRISDbits.TRISD7=OUTPUT_PIN; LATDbits.LATD7 = 1; } 
	#define mAudioDriverON()	LATDbits.LATD7 = 0;    
	#define mAudioDriverOFF()	LATDbits.LATD7 = 1;
	
	/****** PWM Intialization************************************/ 
	// Remap RP13 as PWM output. 
	// configure RC2 as output for PWM  
	// PWM mode, Single output, Active High		
	#define mInitPWM() 			{	EECON2 = 0x55;\
									EECON2 = 0xAA;\
									PPSCONbits.IOLOCK = 0;\
									RPOR13 = 14;\
									EECON2 = 0x55;\
    ...
    #define TimerInterruptFlag PIR1bits.TMR2IF
