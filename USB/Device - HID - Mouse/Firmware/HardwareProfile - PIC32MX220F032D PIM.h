...
#ifndef HARDWARE_PROFILE_PIC32MX220F032D_PIM_H
#define HARDWARE_PROFILE_PIC32MX220F032D_PIM_H
    ...
    #define DEMO_BOARD PIC32MX220F032D_PIM
    #define EXPLORER_16
    ...
    /** SWITCH *********************************************************/
    #define mInitSwitch2()      TRISAbits.TRISA8=1;
    #define mInitSwitch3()      TRISAbits.TRISA9=1;
    #define mInitAllSwitches()  mInitSwitch2();mInitSwitch3();
    #define sw2                 PORTAbits.RA8
    #define sw3                 PORTAbits.RA9

    /** I/O pin definitions ********************************************/
    #define INPUT_PIN 1
    #define OUTPUT_PIN 0
#endif  //HARDWARE_PROFILE_PIC32MX220F032D_PIM_H
