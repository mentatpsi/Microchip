The MCHPUSB Pnp Demo.exe program was written in Microsoft Visual C++ 2005 Express Edition.
The program is meant to show how to use the MCHPUSB custom class driver to write a smooth
"Plug and Play" aware PC application to interface with the USB device.  Use this application
in conjunction with the "USB Device - MCHPUSB Generic Driver Demo" firmware projects
that distribute with MCHPFSUSB v2.x.

In order to use this program, you will need to have the .NET framework version 2.0
...
Microsoft Visual C++ 2005 Redistributeable Package.  Both of these packages get automatically installed
when installing Microsoft Visual C++ 2005 Express Edition.
