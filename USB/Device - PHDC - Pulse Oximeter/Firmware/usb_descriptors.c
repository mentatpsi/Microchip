...
ROM USB_DEVICE_DESCRIPTOR device_dsc=
{
    ...
    0x04D8,                 // Vendor ID
    0x0E44,                 // Product ID: PHDC - Pulse Oximeter demo.
...
ROM BYTE configDescriptor1[]={
    ...
    //0xAf,0x28,            //Device Specialization (WEIGH SCALE - MDC_DEV_SPEC_PROFILE_SCALE)
    ...
    0x04,0x10,              //Device Specialization (Pulse Oximeter - MDC_DEV_SPEC_PROFILE_PULS_OXIM)
...
{'P','H','D','C',' ','P','u','l','s','e',' ','O','x','i','m','e','t','e','r',' ','D','e','m','o'}
};
