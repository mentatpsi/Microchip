 ...
 * Author               Date        Comment
 *~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
 * Sushma Myneni         02/21/13     Original (Rev. 1.0)
********************************************************************/
#ifndef __SELFTESTMODE_H
#define __SELFTESTMODE_H
...
BOOL TestFlash(void);
BOOL TestMRF24J40(void);
void PHYWriteReg(BYTE, BYTE);
BYTE PHYReadReg(BYTE);
