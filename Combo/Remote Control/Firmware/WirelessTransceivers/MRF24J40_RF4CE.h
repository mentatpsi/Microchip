...
********************************************************************/
    ...
    #include "MCHP_MAC.h"
    #include "ConfigMRF24J40_v2.h"

    #define MRF24J40_TICK              MIWI_TICK
    #define MRF24J40_TickGet()         MiWi_TickGet()
    #define MRF24J40_TickGetDiff(a, b) MiWi_TickGetDiff(a, b)
    ...
    #define TX_POWER_N_5_DB                 5
    #define TX_POWER_N_10_DB                10
    #define TX_POWER_N_15_DB                15
    #define TX_POWER_N_20_DB                20
    #define TX_POWER_N_25_DB                20
    #define TX_POWER_N_30_DB                20
    #define TX_POWRE_N_35_DB                35
    #define TX_POWER_N_36_DB                36
    ...
    BOOL DataEncrypt(   BYTE *key, BYTE *Payload, BYTE *PayloadLen, BYTE *SourceIEEEAddress, 
                    DWORD_VAL FrameCounter, BYTE FrameControl);
    BOOL DataDecrypt(   BYTE *key, BYTE *Payload, BYTE *PayloadLen, BYTE *SourceIEEEAddress,
                    DWORD_VAL FrameCounter, BYTE FrameControl);                
#endif
