 ...
 */
	...
	#define TCP_SOCKET_TYPES
		...
		#define TCP_PURPOSE_GOOGLE_STATIC_MAP_CLIENT 12
	#define END_OF_TCP_SOCKET_TYPES
		...
		{
			{TCP_PURPOSE_GOOGLE_STATIC_MAP_CLIENT, TCP_ETH_RAM, 250, 2700},
			...
			//{TCP_PURPOSE_TCP_PERFORMANCE_RX, TCP_ETH_RAM, 40, 200},
