...
//#define PIC32MX220_STARTER_KIT_BOARD
    ...
    #define DIRECTKEY1_CHANNEL  CHANNEL_AN0
    #define DIRECTKEY2_CHANNEL  CHANNEL_AN1
    #define DIRECTKEY3_CHANNEL  CHANNEL_AN4
    #define DIRECTKEY4_CHANNEL  CHANNEL_AN5
    #define DIRECTKEY5_CHANNEL  CHANNEL_AN6
    #define DIRECTKEY6_CHANNEL  CHANNEL_AN7
    #define DIRECTKEY7_CHANNEL  CHANNEL_AN8
    #define DIRECTKEY8_CHANNEL  CHANNEL_AN9
