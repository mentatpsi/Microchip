...
Library used for 4 Channel Slider Demo. 
...
boards DM183026-2. 4 Channel Slider plugin module must be connected to the low part
of the sensors connector (channels from 0 to 3).

**********************************************************************************
   mTouch Capacitive Touch Library Set-up Details for 4 Channel Slider Demo
**********************************************************************************

1)  4 Channel Slider project can be configured as per user's application by
    modifying header file "mTouchConfig.h".
  
2) How to configure 4 Channel Slider?
...
Step 3: Assign sensors used for 4 Channel Slider with MTouchSet4ChSlider(...).

Step 4: Call pereodically MTouchAcquisition() acquisition and MTouchDecode()
        decoding functions.

Step 5: Get state and value from slider using MTouchGet4ChSliderState(...) and
        MTouchGet4ChSliderValue(...) functions.
