...
#define HARDWARE_PROFILE_PIC18F46J50_PIM_H
    ...
    #define sw2                 PORTAbits.RA3 // L
    #define sw3                 PORTAbits.RA0 // R

	/** Mtouch Controls*************************************************/
	#define MTOUCH_SWITCH_R 0 
	#define MTOUCH_SLIDER_TOP 1
	#define MTOUCH_SLIDER_BOTTOM 2
	#define MTOUCH_SWITCH_L 3

	/** POT ************************************************************/
	#define POT  4
    #define mInitPOT()          {TRISAbits.TRISA5=1; ANCON0bits.PCFG4=0;}
