...
void DemoIntroduction(void)
{
    switch(DemoIntroState)
    {
        case 0:
            ...
            oledPutROMString((ROM_STRING)"Card Reader Demo v1.0",1,0);
        ...
        case 2:
            ...
            oledPutROMString((ROM_STRING)"  a USB Mass Storage ",2,0);
        ...
        case 4:
            oledPutROMString((ROM_STRING)"Insert a MicroSD card",0,0);
            oledPutROMString((ROM_STRING)"  and connect the    ",1,0);
            oledPutROMString((ROM_STRING)"  board to the host  ",2,0);
            oledPutROMString((ROM_STRING)"  computer.          ",3,0);
            oledPutROMString((ROM_STRING)"                     ",4,0);
            oledPutROMString((ROM_STRING)"                     ",5,0);
            oledPutROMString((ROM_STRING)"Press Menu to proceed",6,0);
            DemoIntroState = 5;
        ...
        case 6:
            oledPutROMString((ROM_STRING)"Files can be read,   ",0,0);
            oledPutROMString((ROM_STRING)"  deleted, and       ",1,0);
            oledPutROMString((ROM_STRING)"  manipulated like   ",2,0);
            oledPutROMString((ROM_STRING)"  any other drive on ",3,0);
            oledPutROMString((ROM_STRING)"  the computer.      ",4,0);
            oledPutROMString((ROM_STRING)"                     ",5,0);
            oledPutROMString((ROM_STRING)"Press Menu to proceed",6,0);
            DemoIntroState++;
            break;
