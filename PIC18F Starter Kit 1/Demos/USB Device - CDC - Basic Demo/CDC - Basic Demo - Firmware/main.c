...
void DemoIntroduction(void)
{
    switch(DemoIntroState)
    {
        case 0:
            ...
            oledPutROMString((ROM_STRING)"    CDC Demo v1.0    ",1,0);
        ...
        case 2:
            ...
            oledPutROMString((ROM_STRING)"  a USB Communication",2,0);
            oledPutROMString((ROM_STRING)"  device             ",3,0);
            oledPutROMString((ROM_STRING)"It will appear like a",4,0);
            oledPutROMString((ROM_STRING)"  serial (COM) port. ",5,0);
            oledPutROMString((ROM_STRING)"Press Menu to proceed",6,0);
            DemoIntroState = 3;
            break;
        ...
        case 4:
            ...
            oledPutROMString((ROM_STRING)"  a host PC; it may  ",1,0);
            oledPutROMString((ROM_STRING)"  ask for an INF file",2,0);
            oledPutROMString((ROM_STRING)"Point to the INF file",3,0);
            oledPutROMString((ROM_STRING)"  provided on the    ",4,0);
            oledPutROMString((ROM_STRING)"  CD-ROM disc.       ",5,0);
            oledPutROMString((ROM_STRING)"Press Menu to proceed",6,0);
            DemoIntroState = 5;
            break;
        ...
        case 6:
            oledPutROMString((ROM_STRING)"The device will read ",0,0);
            oledPutROMString((ROM_STRING)"  the data from the  ",1,0);
            oledPutROMString((ROM_STRING)"  accelerometer and  ",2,0);
            oledPutROMString((ROM_STRING)"  will send it to the",3,0);
            oledPutROMString((ROM_STRING)"  COM port.          ",4,0);
...
{   
	...
	if (executionTick == 20000)
	{
		switch(commandIndex)
		{
			case 0:
				executionTick = executionTick - 200;
				reg_LSB.val = BMA150_ReadByte(BMA150_ACC_X_LSB);
				sprintf((char *)buffer, (const far rom char *)("BMA150_ACC_X_LSB: 0x%02X\r\n"), (unsigned char)reg_LSB.val);
				putsUSBUSART(buffer);
				commandIndex ++;
				break; 
			...
			case 1:
				executionTick = executionTick - 200;
				reg_MSB.val = BMA150_ReadByte(BMA150_ACC_X_MSB);
				sprintf((char *)buffer, (const far rom char *)"BMA150_ACC_X_MSB: 0x%02X\r\n", (unsigned char)reg_MSB.val);
				putsUSBUSART(buffer);
				commandIndex ++;
				break; 
			...
			case 2:
				executionTick = executionTick - 200;
				reg_LSB.val = BMA150_ReadByte(BMA150_ACC_Y_LSB);
				sprintf((char *)buffer, (const far rom char *)"BMA150_ACC_Y_LSB: 0x%02X\r\n", (unsigned char)reg_LSB.val);
				putsUSBUSART(buffer);
				commandIndex ++;
				break; 
			...
			case 3:
				executionTick = executionTick - 200;
				reg_MSB.val = BMA150_ReadByte(BMA150_ACC_Y_MSB);
				sprintf((char *)buffer, (const far rom char *)"BMA150_ACC_Y_MSB: 0x%02X\r\n", (unsigned char)reg_MSB.val);
				putsUSBUSART(buffer);
				commandIndex ++;
				break; 
			...
			case 4:
				executionTick = executionTick - 200;
				reg_LSB.val = BMA150_ReadByte(BMA150_ACC_Z_LSB);
				sprintf((char *)buffer, (const far rom char *)"BMA150_ACC_Z_LSB: 0x%02X\r\n", (unsigned char)reg_LSB.val);
				putsUSBUSART(buffer);
				commandIndex ++;
				break; 
			...
			case 5:
				executionTick = executionTick - 200;
				reg_MSB.val = BMA150_ReadByte(BMA150_ACC_Z_MSB);
				sprintf((char *)buffer, (const far rom char *)"BMA150_ACC_Z_MSB: 0x%02X\r\n", (unsigned char)reg_MSB.val);
				putsUSBUSART(buffer);
				commandIndex ++;
				break; 
			...
			case 6:
				executionTick = executionTick - 200;
				reg_MSB.val = BMA150_ReadByte(BMA150_TEMP);
				sprintf((char *)buffer, (const far rom char *)"BMA150_TEMP: 0x%02X\r\n", (unsigned char)reg_MSB.val);
				putsUSBUSART(buffer);
				commandIndex ++;
				break; 
